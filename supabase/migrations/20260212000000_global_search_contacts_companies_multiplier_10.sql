-- Increase contact and company relevance multiplier from 3 to 10
...
BEGIN
  ...
  WITH search_results AS (
    ...
    SELECT
      ...
      -- Calculate relevance score (×10 so contacts compete with notes)
      (
        COALESCE(ts_rank(
          to_tsvector('english',
    ...
    SELECT
      ...
      -- Calculate relevance score (×10 so companies compete with notes)
      (
        COALESCE(ts_rank(
          to_tsvector('english',
